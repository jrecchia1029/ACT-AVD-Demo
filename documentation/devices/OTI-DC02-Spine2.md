...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_OTI-DC02-LEAF1_Ethernet56/1 | routed | - | 192.168.12.2/31 | default | 9000 | False | - | - |
| Ethernet2/1 | P2P_LINK_TO_OTI-DC02-LEAF2_Ethernet56/1 | routed | - | 192.168.12.6/31 | default | 9000 | False | - | - |
| Ethernet3/1 | P2P_LINK_TO_OTI-DC02-LEAF3_Ethernet56/1 | routed | - | 192.168.12.10/31 | default | 9000 | False | - | - |
| Ethernet4/1 | P2P_LINK_TO_OTI-DC02-LEAF4_Ethernet56/1 | routed | - | 192.168.12.14/31 | default | 9000 | False | - | - |
| Ethernet5/1 | P2P_LINK_TO_OTI-DC02-LEAF5A_Ethernet56/1 | routed | - | 192.168.12.18/31 | default | 9000 | False | - | - |
| Ethernet6/1 | P2P_LINK_TO_OTI-DC02-LEAF5B_Ethernet56/1 | routed | - | 192.168.12.22/31 | default | 9000 | False | - | - |
...
interface Ethernet1/1
   description P2P_LINK_TO_OTI-DC02-LEAF1_Ethernet56/1
   no shutdown
   mtu 9000
   no switchport
...
interface Ethernet2/1
   description P2P_LINK_TO_OTI-DC02-LEAF2_Ethernet56/1
   no shutdown
   mtu 9000
   no switchport
...
interface Ethernet3/1
   description P2P_LINK_TO_OTI-DC02-LEAF3_Ethernet56/1
   no shutdown
   mtu 9000
   no switchport
...
interface Ethernet4/1
   description P2P_LINK_TO_OTI-DC02-LEAF4_Ethernet56/1
   no shutdown
   mtu 9000
   no switchport
...
interface Ethernet5/1
   description P2P_LINK_TO_OTI-DC02-LEAF5A_Ethernet56/1
   no shutdown
   mtu 9000
   no switchport
...
interface Ethernet6/1
   description P2P_LINK_TO_OTI-DC02-LEAF5B_Ethernet56/1
   no shutdown
   mtu 9000
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.245.218.2/32 |
