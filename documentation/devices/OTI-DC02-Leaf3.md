...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC02-0901-ESX01_PCI_slot_1_Port_2 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | DC02-0901-ESX02_PCI_slot_1_Port_2 | *trunk | *- | *- | *- | 2 |
| Ethernet3 | DC02-0901-ESX03_Onboard_NIC_2 | *trunk | *- | *- | *- | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet55/1 | P2P_LINK_TO_OTI-DC02-SPINE1_Ethernet3/1 | routed | - | 192.168.12.9/31 | default | 1500 | False | - | - |
| Ethernet56/1 | P2P_LINK_TO_OTI-DC02-SPINE2_Ethernet3/1 | routed | - | 192.168.12.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description DC02-0901-ESX01_PCI_slot_1_Port_2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description DC02-0901-ESX02_PCI_slot_1_Port_2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description DC02-0901-ESX03_Onboard_NIC_2
   no shutdown
