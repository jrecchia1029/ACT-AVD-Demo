...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_DC02-0901-ESX01_Onboard_NIC_1 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | SERVER_DC02-0901-ESX02_Onboard_NIC_1 | *trunk | *- | *- | *- | 2 |
| Ethernet3 | SERVER_DC02-0901-ESX03_Onboard_NIC_1 | *trunk | *- | *- | *- | 3 |
| Ethernet4 | SERVER_DC02-0901-ESX04_Onboard_NIC_1 | *trunk | *- | *- | *- | 4 |
| Ethernet5 | SERVER_DC02-0901-ESX05_Onboard_NIC_1 | *trunk | *- | *- | *- | 5 |
| Ethernet6 | SERVER_DC02-0901-ESX06_Onboard_NIC_1 | *trunk | *- | *- | *- | 6 |
| Ethernet25 | SERVER_DC02-0901-SRVA_Port_0 | *trunk | *- | *- | *- | 25 |
| Ethernet47 | SERVER_DC02-0901-ESX02_Onboard_NIC_2 | *trunk | *- | *- | *- | 47 |
| Ethernet48 | SERVER_DC02-0901-ESX01_Onboard_NIC_2 | *trunk | *- | *- | *- | 48 |
...
!
interface Ethernet1
   description SERVER_DC02-0901-ESX01_Onboard_NIC_1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER_DC02-0901-ESX02_Onboard_NIC_1
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description SERVER_DC02-0901-ESX03_Onboard_NIC_1
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description SERVER_DC02-0901-ESX04_Onboard_NIC_1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description SERVER_DC02-0901-ESX05_Onboard_NIC_1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description SERVER_DC02-0901-ESX06_Onboard_NIC_1
   no shutdown
   channel-group 6 mode active
!
interface Ethernet25
   description SERVER_DC02-0901-SRVA_Port_0
   no shutdown
   channel-group 25 mode active
!
interface Ethernet47
   description SERVER_DC02-0901-ESX02_Onboard_NIC_2
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description SERVER_DC02-0901-ESX01_Onboard_NIC_2
   no shutdown
...
| Loopback10 | DIAG_VRF_Production | Production | 10.2.10.3/32 |
| Loopback11 | DIAG_VRF_Development | Development | 10.2.11.3/32 |
...
| 2822 | 10.245.218.3:12822 | 12822:12822 | - | - | learned |
