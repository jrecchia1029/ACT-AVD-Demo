...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_DC02-0901-ESX01_PCI_slot_1_Port_1 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | SERVER_DC02-0901-ESX02_PCI_slot_1_Port_1 | *trunk | *- | *- | *- | 2 |
| Ethernet3 | SERVER_DC02-0901-ESX03_PCI_slot_1_Port_1 | *trunk | *- | *- | *- | 3 |
| Ethernet4 | SERVER_DC02-0901-ESX04_PCI_slot_1_Port_1 | *trunk | *- | *- | *- | 4 |
| Ethernet5 | SERVER_DC02-0901-ESX05_PCI_slot_1_Port_1 | *trunk | *- | *- | *- | 5 |
| Ethernet6 | SERVER_DC02-0901-ESX06_PCI_slot_1_Port_1 | *trunk | *- | *- | *- | 6 |
| Ethernet25 | SERVER_DC02-0901-SRVA_Port_1 | *trunk | *- | *- | *- | 25 |
| Ethernet47 | SERVER_DC02-0901-ESX02_PCI_slot_2_Port_2 | *trunk | *- | *- | *- | 47 |
| Ethernet48 | SERVER_DC02-0901-ESX01_PCI_slot_2_Port_2 | *trunk | *- | *- | *- | 48 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet55/1 | P2P_OTI-DC02-Spine1_Ethernet2/1 | - | 192.168.12.5/31 | default | 1500 | False | - | - |
| Ethernet56/1 | P2P_OTI-DC02-Spine2_Ethernet2/1 | - | 192.168.12.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description SERVER_DC02-0901-ESX01_PCI_slot_1_Port_1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER_DC02-0901-ESX02_PCI_slot_1_Port_1
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description SERVER_DC02-0901-ESX03_PCI_slot_1_Port_1
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description SERVER_DC02-0901-ESX04_PCI_slot_1_Port_1
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description SERVER_DC02-0901-ESX05_PCI_slot_1_Port_1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet6
   description SERVER_DC02-0901-ESX06_PCI_slot_1_Port_1
   no shutdown
   channel-group 6 mode active
!
interface Ethernet25
   description SERVER_DC02-0901-SRVA_Port_1
   no shutdown
   channel-group 25 mode active
!
interface Ethernet47
   description SERVER_DC02-0901-ESX02_PCI_slot_2_Port_2
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description SERVER_DC02-0901-ESX01_PCI_slot_2_Port_2
   no shutdown
   channel-group 48 mode active
!
interface Ethernet55/1
   description P2P_OTI-DC02-Spine1_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet56/1
   description P2P_OTI-DC02-Spine2_Ethernet2/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | SERVER_DC02-0901-ESX01 | trunk | - | - | - | - | - | - | 0000:0000:7ef4:2daa:93ec |
| Port-Channel2 | SERVER_DC02-0901-ESX02 | trunk | - | - | - | - | - | - | 0000:0000:ab3e:11d7:0c8e |
| Port-Channel3 | SERVER_DC02-0901-ESX03 | trunk | - | - | - | - | - | - | 0000:0000:5464:8822:1362 |
| Port-Channel4 | SERVER_DC02-0901-ESX04 | trunk | - | - | - | - | - | - | 0000:0000:11d7:3a44:20e2 |
| Port-Channel5 | SERVER_DC02-0901-ESX05 | trunk | - | - | - | - | - | - | 0000:0000:7869:6402:a182 |
| Port-Channel6 | SERVER_DC02-0901-ESX06 | trunk | - | - | - | - | - | - | 0000:0000:6ec9:e834:38c2 |
| Port-Channel25 | SERVER_DC02-0901-SRVA | trunk | - | - | - | - | - | - | 0000:0000:22ed:72fb:33f6 |
| Port-Channel47 | SERVER_DC02-0901-ESX02 | trunk | - | - | - | - | - | - | 0000:0000:f8ae:690b:c05f |
| Port-Channel48 | SERVER_DC02-0901-ESX01 | trunk | - | - | - | - | - | - | 0000:0000:aa2f:cd7d:9ee5 |
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.245.218.36/32 |
| Loopback10 | DIAG_VRF_Production | Production | 10.2.10.4/32 |
| Loopback11 | DIAG_VRF_Development | Development | 10.2.11.4/32 |
