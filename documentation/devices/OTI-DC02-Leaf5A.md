...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC02-0901-ESX04_Onboard_NIC_2 | *trunk | *899, 999 | *- | *- | 1 |
| Ethernet2 | DC02-0901-ESX06_Onboard_NIC_2 | *trunk | *899, 999 | *- | *- | 2 |
| Ethernet49/1 | DC02-0901-ESX05_PCI_slot_1_Port_2 | *trunk | *1100, 1101, 1102 | *- | *- | 491 |
| Ethernet50/1 | DC02-0901-ESX06_PCI_slot_1_Port_2 | *trunk | *887, 888 | *- | *- | 501 |
...
!
interface Ethernet1
   description DC02-0901-ESX04_Onboard_NIC_2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description DC02-0901-ESX06_Onboard_NIC_2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet49/1
   description DC02-0901-ESX05_PCI_slot_1_Port_2
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description DC02-0901-ESX06_PCI_slot_1_Port_2
   no shutdown
...
| 192.168.10.249 | 65005 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
