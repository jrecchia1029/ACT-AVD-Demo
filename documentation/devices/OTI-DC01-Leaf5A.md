...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet52/1 | P2P_LINK_TO_OTI-DC02-Leaf5A_Ethernet52/1 | routed | - | 192.168.10.249/31 | default | 9000 | False | - | - |
| Ethernet55/1 | P2P_LINK_TO_OTI-DC01-SPINE1_Ethernet5/1 | routed | - | 192.168.11.17/31 | default | 9000 | False | - | - |
| Ethernet56/1 | P2P_LINK_TO_OTI-DC01-SPINE2_Ethernet5/1 | routed | - | 192.168.11.19/31 | default | 9000 | False | - | - |
...
interface Ethernet53/1
   description MLAG_PEER_OTI-DC01-Leaf5B_Ethernet53/1
   no shutdown
   channel-group 531 mode active
!
interface Ethernet54/1
   description MLAG_PEER_OTI-DC01-Leaf5B_Ethernet54/1
   no shutdown
   channel-group 531 mode active
!
interface Ethernet55/1
   description P2P_LINK_TO_OTI-DC01-SPINE1_Ethernet5/1
   no shutdown
   mtu 9000
   no switchport
...
interface Ethernet56/1
   description P2P_LINK_TO_OTI-DC01-SPINE2_Ethernet5/1
   no shutdown
   mtu 9000
   no switchport
...
| Vlan3009 |  BLUE  |  192.168.13.72/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  RED  |  192.168.13.72/31  |  -  |  -  |  -  |  -  |  -  |
...
| 192.168.13.73 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 192.168.13.73 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.245.217.7:10011 | 10011:10011 | - | - | learned |
| 12 | 10.245.217.7:10012 | 10012:10012 | - | - | learned |
| 13 | 10.245.217.7:10013 | 10013:10013 | - | - | learned |
| 21 | 10.245.217.7:10021 | 10021:10021 | - | - | learned |
| 22 | 10.245.217.7:10022 | 10022:10022 | - | - | learned |
| 3401 | 10.245.217.7:13401 | 13401:13401 | - | - | learned |
| 3402 | 10.245.217.7:13402 | 13402:13402 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 10.245.217.7:10 | connected |
| RED | 10.245.217.7:11 | connected |
...
router bgp 65005
   ...
   !
   vlan 11
      rd 10.245.217.7:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 10.245.217.7:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 13
      rd 10.245.217.7:10013
      route-target both 10013:10013
      redistribute learned
   !
   vlan 21
      rd 10.245.217.7:10021
      route-target both 10021:10021
      redistribute learned
   !
   vlan 22
      rd 10.245.217.7:10022
      route-target both 10022:10022
      redistribute learned
   !
   vlan 3401
      rd 10.245.217.7:13401
      route-target both 13401:13401
      redistribute learned
   !
   vlan 3402
      rd 10.245.217.7:13402
