...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC01-0601-ESX03_PCI_slot_2_Port_2 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | DC01-0601-ESX04_PCI_slot_2_Port_2 | *trunk | *- | *- | *- | 2 |
| Ethernet3 | DC01-0601-ESX05_PCI_slot_2_Port_2 | *trunk | *- | *- | *- | 3 |
| Ethernet4 | DC01-0601-ESX06_PCI_slot_2_Port_2 | *trunk | *- | *- | *- | 4 |
| Ethernet11 | DC01-0601-SRVA_Port_1 | *trunk | *- | *- | *- | 11 |
| Ethernet12 | DC01-0601-SRVB_Port_1 | *trunk | *- | *- | *- | 12 |
| Ethernet13 | DC01-0601-SRVC_Port_1 | *trunk | *- | *- | *- | 13 |
| Ethernet14 | DC01-0601-SRVD_Port_1 | *trunk | *- | *- | *- | 14 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet55/1 | P2P_LINK_TO_OTI-DC01-SPINE1_Ethernet4/1 | routed | - | 192.168.11.13/31 | default | 1500 | False | - | - |
| Ethernet56/1 | P2P_LINK_TO_OTI-DC01-SPINE2_Ethernet4/1 | routed | - | 192.168.11.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description DC01-0601-ESX03_PCI_slot_2_Port_2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description DC01-0601-ESX04_PCI_slot_2_Port_2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description DC01-0601-ESX05_PCI_slot_2_Port_2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description DC01-0601-ESX06_PCI_slot_2_Port_2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet11
   description DC01-0601-SRVA_Port_1
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description DC01-0601-SRVB_Port_1
   no shutdown
   channel-group 12 mode active
!
interface Ethernet13
   description DC01-0601-SRVC_Port_1
   no shutdown
   channel-group 13 mode active
!
interface Ethernet14
   description DC01-0601-SRVD_Port_1
   no shutdown
   channel-group 14 mode active
!
interface Ethernet55/1
   description P2P_LINK_TO_OTI-DC01-SPINE1_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet56/1
   description P2P_LINK_TO_OTI-DC01-SPINE2_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | DC01-0601-ESX03 | switched | trunk | - | - | - | - | - | - | 0000:0000:cf03:9408:ec9a |
| Port-Channel2 | DC01-0601-ESX04 | switched | trunk | - | - | - | - | - | - | 0000:0000:cabf:e649:c9a1 |
| Port-Channel3 | DC01-0601-ESX05 | switched | trunk | - | - | - | - | - | - | 0000:0000:6e36:5d4b:7972 |
| Port-Channel4 | DC01-0601-ESX06 | switched | trunk | - | - | - | - | - | - | 0000:0000:5fad:6495:5ad4 |
| Port-Channel11 | DC01-0601-SRVA | switched | trunk | - | - | - | - | - | - | 0000:0000:635d:134d:9b86 |
| Port-Channel12 | DC01-0601-SRVB | switched | trunk | - | - | - | - | - | - | 0000:0000:873f:92fb:cd3d |
| Port-Channel13 | DC01-0601-SRVC | switched | trunk | - | - | - | - | - | - | 0000:0000:88a9:5b0f:593d |
| Port-Channel14 | DC01-0601-SRVD | switched | trunk | - | - | - | - | - | - | 0000:0000:60ea:4b72:cbc5 |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.245.217.6/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.245.217.38/32 |
| Loopback10 | Production_VTEP_DIAGNOSTICS | Production | 10.1.10.6/32 |
| Loopback11 | Development_VTEP_DIAGNOSTICS | Development | 10.1.11.6/32 |
...
| 2822 | 10.245.217.6:12822 | 12822:12822 | - | - | learned |
