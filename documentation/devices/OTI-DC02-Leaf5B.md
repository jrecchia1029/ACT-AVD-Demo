...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_DC02-0901-ESX04_PCI_slot_2_Port_2 | *trunk | *899,999 | *- | *- | 1 |
| Ethernet2 | SERVER_DC02-0901-ESX06_PCI_slot_2_Port_2 | *trunk | *899,999 | *- | *- | 2 |
| Ethernet49/1 | SERVER_DC02-0901-ESX05_PCI_slot_2_Port_1 | *trunk | *1100-1102 | *- | *- | 491 |
| Ethernet50/1 | SERVER_DC02-0901-ESX06_PCI_slot_2_Port_1 | *trunk | *887-888 | *- | *- | 501 |
| Ethernet53/1 | MLAG_OTI-DC02-Leaf5A_Ethernet53/1 | *trunk | *- | *- | *MLAG | 531 |
| Ethernet54/1 | MLAG_OTI-DC02-Leaf5A_Ethernet54/1 | *trunk | *- | *- | *MLAG | 531 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet52/1 | P2P_OTI-DC01-Leaf5B_Ethernet52/1 | - | 192.168.10.251/31 | default | 1500 | False | - | - |
| Ethernet55/1 | P2P_OTI-DC02-Spine1_Ethernet6/1 | - | 192.168.12.21/31 | default | 1500 | False | - | - |
| Ethernet56/1 | P2P_OTI-DC02-Spine2_Ethernet6/1 | - | 192.168.12.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description SERVER_DC02-0901-ESX04_PCI_slot_2_Port_2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER_DC02-0901-ESX06_PCI_slot_2_Port_2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet49/1
   description SERVER_DC02-0901-ESX05_PCI_slot_2_Port_1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description SERVER_DC02-0901-ESX06_PCI_slot_2_Port_1
   no shutdown
   channel-group 501 mode active
!
interface Ethernet52/1
   description P2P_OTI-DC01-Leaf5B_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet53/1
   description MLAG_OTI-DC02-Leaf5A_Ethernet53/1
   no shutdown
   channel-group 531 mode active
!
interface Ethernet54/1
   description MLAG_OTI-DC02-Leaf5A_Ethernet54/1
   no shutdown
   channel-group 531 mode active
!
interface Ethernet55/1
   description P2P_OTI-DC02-Spine1_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet56/1
   description P2P_OTI-DC02-Spine2_Ethernet6/1
   no shutdown
   mtu 1500
   no switchport
...
| Port-Channel531 | MLAG_OTI-DC02-Leaf5A_Port-Channel531 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel531
   description MLAG_OTI-DC02-Leaf5A_Port-Channel531
   no shutdown
   switchport mode trunk
...
| Loopback10 | DIAG_VRF_Production | Production | 10.2.10.8/32 |
...
router bgp 65105
   ...
   neighbor 192.168.14.72 description OTI-DC02-Leaf5A_Vlan4093
   ...
   vrf Production
      ...
      router-id 10.245.218.8
      neighbor 192.168.14.72 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 192.168.14.72 description OTI-DC02-Leaf5A_Vlan3009
