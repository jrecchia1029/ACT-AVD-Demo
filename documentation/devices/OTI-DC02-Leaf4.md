...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_DC02-0901-ESX01_PCI_slot_2_Port_1 | *trunk | *- | *- | *- | 1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet55/1 | P2P_OTI-DC02-Spine1_Ethernet4/1 | - | 192.168.12.13/31 | default | 1500 | False | - | - |
| Ethernet56/1 | P2P_OTI-DC02-Spine2_Ethernet4/1 | - | 192.168.12.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description SERVER_DC02-0901-ESX01_PCI_slot_2_Port_1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER_DC02-0901-ESX02_PCI_slot_2_Port_1
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description SERVER_DC02-0901-ESX03_PCI_slot_2_Port_2
   no shutdown
...
interface Ethernet50/1
   description SERVER_DC02-0901-ESX04_PCI_slot_2_Port_1
   no shutdown
   channel-group 501 mode active
!
interface Ethernet55/1
   description P2P_OTI-DC02-Spine1_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet56/1
   description P2P_OTI-DC02-Spine2_Ethernet4/1
   no shutdown
   mtu 1500
   no switchport
...
| Loopback10 | DIAG_VRF_Production | Production | 10.2.10.6/32 |
| Loopback11 | DIAG_VRF_Development | Development | 10.2.11.6/32 |
...
| 2822 | 10.245.218.6:12822 | 12822:12822 | - | - | learned |
