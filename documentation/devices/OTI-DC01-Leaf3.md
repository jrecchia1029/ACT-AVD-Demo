...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC01-0601-ESX03_Onboard_NIC_2 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | DC01-0601-ESX04_Onboard_NIC_2 | *trunk | *- | *- | *- | 2 |
| Ethernet3 | DC01-0601-ESX05_Onboard_NIC_2 | *trunk | *- | *- | *- | 3 |
| Ethernet4 | DC01-0601-ESX06_Onboard_NIC_2 | *trunk | *- | *- | *- | 4 |
| Ethernet11 | DC01-0601-SRVA_Port_0 | *trunk | *- | *- | *- | 11 |
| Ethernet12 | DC01-0601-SRVB_Port_0 | *trunk | *- | *- | *- | 12 |
| Ethernet13 | DC01-0601-SRVC_Port_0 | *trunk | *- | *- | *- | 13 |
| Ethernet14 | DC01-0601-SRVD_Port_0 | *trunk | *- | *- | *- | 14 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet55/1 | P2P_LINK_TO_OTI-DC01-SPINE1_Ethernet3/1 | routed | - | 192.168.11.9/31 | default | 1500 | False | - | - |
| Ethernet56/1 | P2P_LINK_TO_OTI-DC01-SPINE2_Ethernet3/1 | routed | - | 192.168.11.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description DC01-0601-ESX03_Onboard_NIC_2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description DC01-0601-ESX04_Onboard_NIC_2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description DC01-0601-ESX05_Onboard_NIC_2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description DC01-0601-ESX06_Onboard_NIC_2
   no shutdown
   channel-group 4 mode active
!
interface Ethernet11
   description DC01-0601-SRVA_Port_0
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description DC01-0601-SRVB_Port_0
   no shutdown
   channel-group 12 mode active
!
interface Ethernet13
   description DC01-0601-SRVC_Port_0
   no shutdown
   channel-group 13 mode active
!
interface Ethernet14
   description DC01-0601-SRVD_Port_0
   no shutdown
   channel-group 14 mode active
!
interface Ethernet55/1
   description P2P_LINK_TO_OTI-DC01-SPINE1_Ethernet3/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet56/1
   description P2P_LINK_TO_OTI-DC01-SPINE2_Ethernet3/1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.245.217.5/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.245.217.37/32 |
| Loopback10 | Production_VTEP_DIAGNOSTICS | Production | 10.1.10.5/32 |
| Loopback11 | Development_VTEP_DIAGNOSTICS | Development | 10.1.11.5/32 |
...
| 2822 | 10.245.217.5:12822 | 12822:12822 | - | - | learned |
