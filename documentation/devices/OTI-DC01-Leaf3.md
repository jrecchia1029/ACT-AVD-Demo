...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet55/1 | P2P_LINK_TO_OTI-DC01-SPINE1_Ethernet3/1 | routed | - | 192.168.11.9/31 | default | 9000 | False | - | - |
| Ethernet56/1 | P2P_LINK_TO_OTI-DC01-SPINE2_Ethernet3/1 | routed | - | 192.168.11.11/31 | default | 9000 | False | - | - |
...
| Loopback10 | BLUE_VTEP_DIAGNOSTICS | BLUE | 10.1.10.5/32 |
| Loopback11 | RED_VTEP_DIAGNOSTICS | RED | 10.1.11.5/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 11 | 10.245.217.5:10011 | 10011:10011 | - | - | learned |
| 12 | 10.245.217.5:10012 | 10012:10012 | - | - | learned |
| 13 | 10.245.217.5:10013 | 10013:10013 | - | - | learned |
...
| --- | ------------------- | ------------ |
| BLUE | 10.245.217.5:10 | connected |
| RED | 10.245.217.5:11 | connected |
...
router bgp 65003
   ...
   !
   vlan 11
      rd 10.245.217.5:10011
      route-target both 10011:10011
      redistribute learned
   !
   vlan 12
      rd 10.245.217.5:10012
      route-target both 10012:10012
      redistribute learned
   !
   vlan 13
      rd 10.245.217.5:10013
...
```eos
!
ip address virtual source-nat vrf BLUE address 10.1.10.5
ip address virtual source-nat vrf RED address 10.1.11.5
```
